...
@Component({
  selector: 'app-sales-invoce-list',
  templateUrl: './sales-invoce-list.page.html',
  styleUrls: ['./sales-invoce-list.page.scss'],
})
export class SalesInvoceListPage implements OnInit {
